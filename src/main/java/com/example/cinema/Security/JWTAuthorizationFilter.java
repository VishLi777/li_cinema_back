...
import static com.example.cinema.Security.SecurityConstants.HEADER_JWT_STRING;
import static com.example.cinema.Security.SecurityConstants.TOKEN_PREFIX;
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request, HttpServletResponse response){
        ...
        if(header != null){
            ...
            try {
                ...
                String login = jwTokenService.getNameFromJWT(token);
                ...
                StaticMethods.createResponse(468, "Token was expired");
                return null;
            }
            return null;
        }
